...
symptomController.createSymptom = (req, res, next) => {
    ...
    // }
    res.send(`createSymptom: SUCCESS`);
};
...
symptomController.readSymptoms = (req, res, next) => {
    /**
     * FIXME: LUIS
     */
...
symptomController.updateSymptom = (req, res, next) => {
     ...
     * TODO: LUIS
     */
    res.send(`updateSymptom: SUCCESS`);
}
...
symptomController.deleteSymptom = (req, res, next) => {
     ...
     * TODO: LUIS
     */
    res.send(`deleteSymptom: SUCCESS`);
}
